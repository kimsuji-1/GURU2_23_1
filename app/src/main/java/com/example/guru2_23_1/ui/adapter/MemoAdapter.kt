package com.example.guru2_23_1.ui.adapter
...
class MemoAdapter(context: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    private class HolderView(view: View) : RecyclerView.ViewHolder(view){
        ...
        val text_memo = view.findViewById<TextView>(R.id.text_title)
        val text_datetime = view.findViewById<TextView>(R.id.text_title)
    }
}